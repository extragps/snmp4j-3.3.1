...
/**
 * The <code>MessageProcessingModel</code> interface defines common methods to all SNMP message processing models.
...
public interface MessageProcessingModel {
     ...
     * @param pdu
     *         the <code>PDU</code> to send. For a SNMPv1 trap <code>pdu</code> has to be a {@link org.snmp4j.PDUv1}
     ...
     *         the <code>MessageDispatcher</code> instance to be used to send reports. Thus,
     *         <code>messageDispatcher</code> is typically the calling module.
     * @param transportAddress
