...
/**
 * The <code>SNMP4JSettings</code> class implements a central configuration class of the SNMP4J framework. As a rule of
...
public final class SNMP4JSettings {
     ...
     * types, SMI syntaxes, etc. through property files defined via System properties. If set to <code>false</code> all
     ...
     * such exceptions then set this value to <code>true</code>.
     *
     * @since 1.8.1
     */
     ...
     *
     * @param enable
     *         if <code>true</code> activates extensibility or if <code>false</code> disables it. In the latter case,
     ...
     *
     * @return if <code>true</code> the extensibility is enabled otherwise it is disabled. In the latter case, SNMP4J's
     ...
     *
     * @return an <code>OIDTextFormat</code> instance.
     * @since 1.10
     */
     ...
     *
     * @return an <code>VariableTextFormat</code> instance.
     * @since 1.10
     */
     ...
     * version PDUs. The default is <code>false</code>. Note: By setting this to <code>true</code> you disable SNMP
     * standard conformity.
     *
     * @param allowSNMPv2InV1
     *         if set to <code>true</code>, SNMP4J will allow Counter64 objects in SNMPv1 PDUs although the SNMPv1
