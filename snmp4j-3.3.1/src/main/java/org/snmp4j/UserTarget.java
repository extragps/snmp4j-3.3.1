...
public class UserTarget<A extends Address> extends SecureTarget<A> {
     ...
     *         the authoritative engine ID as a possibly zero length byte array which must not be <code>null</code>.
     */
    ...
    public boolean equals(Object o) {
        ...
        return authoritativeEngineID != null ? authoritativeEngineID.equals(that.authoritativeEngineID) :
                that.authoritativeEngineID == null;
    }
