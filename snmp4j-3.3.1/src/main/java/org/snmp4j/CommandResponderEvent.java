...
public class CommandResponderEvent<A extends Address> extends EventObject {
     ...
     *         needed for responding a request, will be <code>null</code> for notifications.
     */
    ...
    /**
     * Creates shallow copy of the supplied <code>CommandResponderEvent</code> but the source of the event is set to the
     * supplied source.
     *
     * @param source
     ...
     *
     * @param processed
     *         If set to <code>true</code>, the dispatcher stops dispatching this event to other event listeners,
