 ...
 * @since 2.0
 */
public class DummyTransport1<A extends IpAddress> extends AbstractTransportMapping<A> {
    ...
    public DummyTransport1() {
        this.listening = false;
    }

    public DummyTransport1(A senderAddress) {
        this.listenAddress = senderAddress;
    }

    public DummyTransport1(A senderAddress, A receiverAddress) {
        this.listenAddress = senderAddress;
            ...
            while (!stop) {
                ...
                if (nextMessage != null) {
                    TransportStateReference stateReference =
                            new TransportStateReference(DummyTransport1.this, listenAddress, null,
    ...
    public class DummyTransportResponder extends AbstractTransportMapping<A> {
        ...
        @Override
        public Class<? extends Address> getSupportedAddressClass() {
            return DummyTransport1.this.getSupportedAddressClass();
        }
