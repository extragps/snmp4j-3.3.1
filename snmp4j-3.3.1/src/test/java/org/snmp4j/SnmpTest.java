...
import org.snmp4j.transport.DummyTransport1;
 ...
 * against a {@link DummyTransport1} which allows to directly link two virtual
...
public class SnmpTest extends TestCase {
    ...
    private DummyTransport1<UdpAddress> transportMappingCG;
    ...
    private UserTarget<UdpAddress> userTarget =
            new UserTarget<>((UdpAddress)GenericAddress.parse("udp:127.0.0.1/161"),
                    new OctetString("SHADES"), new byte[0]);
    ...
    public static void setupBeforeClass() throws Exception {
        ...
        assertEquals(DummyTransport1.class,
    ...
    public void setUp() throws Exception {
        transportMappingCG = new DummyTransport1<>(new UdpAddress("127.0.0.1/4967"));
    ...
    public void testGetV3_RFC3414_3_2_3() throws Exception {
        ...
        snmpCommandGenerator.setReportHandler(new Snmp.ReportHandler() {
            @Override
            public <A extends Address> void processReport(PduHandle pduHandle, CommandResponderEvent<A> event) {
...
//      Thread.sleep(1L);
    ...
    public void testMPv3EngineIdCache() throws Exception {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            DummyTransport1<UdpAddress> transportMappingCG = new DummyTransport1<UdpAddress>(new UdpAddress("127.0.0.1/" + (i + 30000)));
            snmpCommandGenerator = new Snmp(transportMappingCG);
