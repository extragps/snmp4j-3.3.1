...
public class TreeUtils extends AbstractSnmpUtility {
    ...
    /**
     * Creates a <code>TreeUtils</code> instance. The created instance is thread safe as long as the supplied
     * <code>Session</code> and
     * <code>PDUFactory</code> are thread safe.
     *
     * @param snmpSession
     *         a SNMP <code>Session</code> instance.
     * @param pduFactory
     *         a <code>PDUFactory</code> instance that creates the PDU that are used by this instance to retrieve MIB
     ...
     *
     * @param target
     *         a <code>Target</code> that specifies the target command responder including its network transport
     *         address.
     * @param rootOID
     *         the OID that specifies the root of the sub-tree to retrieve (not included).
     *
     * @return a possibly empty List of <code>TreeEvent</code> instances where each instance carries zero or more values
     ...
     *
     * @return a possibly empty List of <code>TreeEvent</code> instances where each instance carries zero or
     * <code>rootOIDs.length</code> values.
     * @since 2.1
     */
     ...
     * @param listener
     *         the <code>TreeListener</code> that processes the {@link TreeEvent}s generated by this method. Each event
    ...
    /**
     * Sets the maximum number of the variable bindings per <code>TreeEvent</code> returned by this instance.
     *
    ...
    /**
     * Gets the maximum number of the variable bindings per <code>TreeEvent</code> returned by this instance.
     *
