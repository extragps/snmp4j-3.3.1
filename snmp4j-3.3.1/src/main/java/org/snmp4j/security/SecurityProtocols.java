...
/**
 * The <code>SecurityProtocols</code> class holds all authentication and privacy protocols for a SNMP entity.
 * <p>
 * To register security protocols other than the default, set the system property {@link #SECURITY_PROTOCOLS_PROPERTIES}
 * to a customized version of the <code>SecurityProtocols.properties</code> file. The path has to be specified
...
// Unsecure:      addAuthenticationProtocol(new AuthSHA());
     ...
     *         an <code>OID</code> identifying the privacy protocol the key should be created for.
     * @param authProtocolID
     *         an <code>OID</code> identifying the authentication protocol to use.
     * @param passwordString
     *         the authentication pass phrase.
